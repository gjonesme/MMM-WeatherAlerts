...
const WeatherAlertProvider = Class.extend({
	...
	fetchCurrentWeatherAlerts: function () {
		Log.warn(`Weather provider: ${this.providerName} does not subclass the fetchCurrentWeatherAlerts method.`);
	},
...
WeatherAlertProvider.register = function (providerIdentifier, providerDetails) {
	WeatherAlertProvider.providers[providerIdentifier.toLowerCase()] = WeatherAlertProvider.extend(providerDetails);
};
